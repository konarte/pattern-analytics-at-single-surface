...
"%_JAVACCMD%" -d %_CLASSES% -classpath %_CLASSPATH% %_SOURCEPATH%\edu\mgupi\pass\db\surfaces\*.java %_SOURCEPATH%\edu\mgupi\pass\db\defects\*.java %_SOURCEPATH%\edu\mgupi\pass\db\locuses\*.java %_SOURCEPATH%\edu\mgupi\pass\db\sensors\*.java %_SOURCEPATH%\ormsamples\*.java 
