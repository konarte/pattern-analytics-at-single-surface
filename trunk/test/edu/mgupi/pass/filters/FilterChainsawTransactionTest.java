...
public class FilterChainsawTransactionTest {
	...
	private FilterChainsawTransactional chainsawTrans = null;
	...
	public void testContainData() throws Exception {
		...
		ParamTest.compareTwoClonedParametersDefinitions(ParamHelper.getParameter("p2_string",
				filter2.getParams()), param);
