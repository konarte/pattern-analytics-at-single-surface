...
"%_JAVACCMD%" -d %_CLASSES% -classpath %_CLASSPATH% %_SOURCEPATH%\edu\mgupi\pass\db\defects\*.java %_SOURCEPATH%\edu\mgupi\pass\db\locuses\*.java %_SOURCEPATH%\edu\mgupi\pass\db\sensors\*.java %_SOURCEPATH%\edu\mgupi\pass\db\surfaces\*.java %_SOURCEPATH%\ormsamples\*.java 
...
"%_JAVACMD%" -cp lib\orm.jar org.orm.util.LazyPropInstrument %_CLASSES%\edu\mgupi\pass\db\defects\DefectClasses.class %_CLASSES%\edu\mgupi\pass\db\defects\DefectTypes.class %_CLASSES%\edu\mgupi\pass\db\defects\Defects.class %_CLASSES%\edu\mgupi\pass\db\defects\DefectTypeOptions.class %_CLASSES%\edu\mgupi\pass\db\locuses\LModules.class %_CLASSES%\edu\mgupi\pass\db\locuses\LFilters.class %_CLASSES%\edu\mgupi\pass\db\locuses\Locuses.class %_CLASSES%\edu\mgupi\pass\db\locuses\LocusSources.class %_CLASSES%\edu\mgupi\pass\db\locuses\LocusAppliedFilters.class %_CLASSES%\edu\mgupi\pass\db\locuses\LocusModuleData.class %_CLASSES%\edu\mgupi\pass\db\locuses\LocusAppliedModule.class %_CLASSES%\edu\mgupi\pass\db\locuses\LocusAppliedModuleParams.class %_CLASSES%\edu\mgupi\pass\db\locuses\LocusAppliedFilterParams.class %_CLASSES%\edu\mgupi\pass\db\sensors\Sensors.class %_CLASSES%\edu\mgupi\pass\db\sensors\SensorClasses.class %_CLASSES%\edu\mgupi\pass\db\sensors\SensorTypes.class %_CLASSES%\edu\mgupi\pass\db\surfaces\SurfaceClasses.class %_CLASSES%\edu\mgupi\pass\db\surfaces\Surfaces.class %_CLASSES%\edu\mgupi\pass\db\surfaces\SurfaceTypes.class %_CLASSES%\edu\mgupi\pass\db\surfaces\Materials.class 
set _JAVACCMD=
set _JAVACMD=
set _CLASSES=
set _CLASSPATH=
