...
public class PlaceImageFilter implements IFilter {
	...
	private Param PLACE = new Param("Place", "Размещение", ParamType.STRING, PLACE_CENTER,
			new Object[] { PLACE_CENTER, PLACE_TOP_LEFT, PLACE_TOP_RIGHT, PLACE_BOTTOM_LEFT,
					PLACE_BOTTOM_RIGHT }, new String[] { "По центру", "Слева сверху",
	...
	public BufferedImage convert(BufferedImage source) throws FilterException {
		...
		logger.debug("Сдвиг изображения {}x{}, {} as {}.", new Object[] { newWidth, newHeight,
				newPlace, backGround });
		...
		if (newPlace.equals("center")) {
			...
			throw new FilterException("Unknown value of parameter " + PLACE.getName() + ": "
					+ newPlace);
		}
