...
public class ResizeFilter implements IFilter {
	...
	private Param INTERPOLATION_METHOD = new Param("Method", "Метод конвертирования",
			ParamType.STRING, "biliner", new Object[] { "bicubic", "biliner", "nearest_n" },
	...
	public BufferedImage convert(BufferedImage source) throws FilterException {
		...
		if (logger.isDebugEnabled()) {
			logger
					.debug(
							"Resizing image from {}x{} to {}x{}, method {}. Actual size is {}x{}. ThumbRate = {}.",
							new Object[] { source.getWidth(), source.getHeight(), thumb.width,
									thumb.height, myMethod, newSize.width, newSize.height,
									lastThumbRate });
		}
		...
		BufferedImage dest = new BufferedImage(newSize.width, newSize.height,
