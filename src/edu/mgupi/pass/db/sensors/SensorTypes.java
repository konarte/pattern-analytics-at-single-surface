...
/**
 * Тип датчика для вихретоков: с перпендикулярным расположением катушки, с
 * параллельным расположением катушки (проходной), многокатушечный.
 * 
 * http://www.acta-ndt.ru/?id=2007, пленочный плоский, многосекционный(под
 * вопросом).
 * 
...
public class SensorTypes {
	...
	private String name;
	/**
	 * Изображение (конструктивная схема) датчика в виде картинки. Картинка
	 * должна быть стандартизированного размера. 256x256 пикселей.
	 * 
	 * Формат хранения -- PNG
	 */
